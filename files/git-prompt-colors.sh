...
override_git_prompt_colors() {
  ...
  GIT_PROMPT_START_USER="_LAST_COMMAND_INDICATOR_ ${DimWhite}${Time12a}${ResetColor} ${Cyan}${PathShort}${ResetColor}"
  GIT_PROMPT_START_ROOT="_LAST_COMMAND_INDICATOR_ ${DimWhite}${Time12a}${ResetColor} ${Red}${PathShort}${ResetColor}"
  GIT_PROMPT_END_USER=" $ "
  GIT_PROMPT_END_ROOT=" # "
