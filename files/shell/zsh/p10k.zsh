# Generated by Powerlevel10k configuration wizard on 2019-10-22 at 20:13 IST.
...
() {
  ...
  function my_git_formatter() {
    ...
    (( VCS_STATUS_PUSH_COMMITS_AHEAD && !VCS_STATUS_PUSH_COMMITS_BEHIND )) && res+="${sep}"
    ...
    (( VCS_STATUS_NUM_UNTRACKED  )) && res+="${sep}${untracked}${(g::)POWERLEVEL9K_VCS_UNTRACKED_ICON}${VCS_STATUS_NUM_UNTRACKED}"
  ...
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND=44
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_FOREGROUND=71
  ...
  # typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|helmsman|flux|fluxctl|stern'
